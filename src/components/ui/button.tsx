  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        danger: "bg-gradient-to-r from-crimson to-crimson-dark text-white hover:opacity-90 hover:scale-105 font-semibold shadow-md hover:shadow-lg",
        hero: "bg-gradient-to-r from-navy to-navy-light text-primary-foreground hover:opacity-90 hover:scale-105 font-semibold shadow-md hover:shadow-lg border-2 border-gold/20",
        accent: "bg-gradient-to-r from-gold to-gold-dark text-navy hover:opacity-90 hover:scale-105 font-semibold shadow-md hover:shadow-lg",
      },
      size: {
